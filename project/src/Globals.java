...
class Globals
{
	...
	public static String ApplicationName = "SDLHana";
	public static String AppLibraries[] = { "sdl_native_helpers", "sdl-1.2", "sdl_image" };
	public static String AppMainLibraries[] = {  "application", "sdl_main" };
	public static final boolean Using_SDL_1_3 = false;
	public static final boolean Using_SDL_2_0 = false;
	public static String[] DataDownloadUrl = { "!!Game data is 1 Mb|sdlhana.zip",  };
