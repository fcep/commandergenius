...
APP_MODULES := application sdl-1.2 sdl_main sdl_native_helpers jpeg png ogg flac vorbis freetype sdl_image
...
SDL_JAVA_PACKAGE_PATH := com_example_francesco_sdlhana
...
SDL_CURDIR_PATH := com.example.francesco.sdlhana
...
APPLICATION_ADDITIONAL_CFLAGS := -O2 -finline-functions

APPLICATION_ADDITIONAL_LDFLAGS := -fuse-ld=bfd
